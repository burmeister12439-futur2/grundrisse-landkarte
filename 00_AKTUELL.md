# Was hier gerade gilt

**GRUNDRISSE Foresight-Landkarte (Repositorium)** · Stand: 2026-09-23

**Projekt:** GRUNDRISSE Foresight-Landkarte (Repositorium)
**Rolle:** foresightlab
**Status:** aktiv
...
**Geltende Fassung der Seite:** `index.html`, Stand 23.09.2026, Commit `23da0e1`. HALs Schlussprüfung von Commit `1782c4a` war nicht vollständig bestanden; die sechs Befunde sind bereinigt. Das Protokoll liegt in der inhaltlichen Heimat unter `Revision_Landkarte/2026-09-23_GRUNDRISSE_Schlussprüfung_Bereinigung_v1.md`. Aufbau nach der von Klaus beschlossenen Gliederung **A bis I plus Anhang**, abgenommen von HAL mit grünem Votum zum Entwurf `c51afd3`. Begriffe: Szenarien 2045 plus, Grundriss-Kandidat. Zentrales Endprodukt ist die Karte der Grundrisse 2045 in G. Neue Wertschöpfungsmuster laufen als Querschnittsdimension durch C bis H. Offen und ans Kern-Team verwiesen: vier oder sechs Pfeiler, benannt in Abschnitt I.
...
**Ortslage:** Dieser Ordner liegt in `Documents/GitHub` und damit außerhalb von `lab-aktuell`. Im Cowork-Arbeitsstand ist das Projekt unter seiner inhaltlichen Heimat geführt, nicht unter diesem Ordner.
